/**
 * 🚀 SHEINVERSE SNIPER - OPTIMIZED VERSION
 * - Fetches ALL products (multiple pages)
 * - No stock checking (fast & reliable)
 * - Sends alerts for all new products
 */
...
async function fetchAllProducts(cookies) {
    ...
    if (firstPageResult.pagination) {
        ...
        console.log(`📊 Total products in category: ${totalResults}`);
    ...
    console.log(`\n📦 Total products fetched: ${allProducts.length}/${totalResults}`);
    return allProducts;
}

async function runSniper() {
    console.log('\n🚀 ========================================');
    console.log('   SHEINVERSE SNIPER - OPTIMIZED');
    console.log('   ========================================\n');
